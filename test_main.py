...
def travisTest():  # sends email to itself to verify it works (for travis CI)
    ...
    print("Test 11: Navigating to inbox without logging in.")
    try:
        redirect("/inbox")
        ...
        print("PASS")
    print("Test 12: Navigating to director without logging in.")
    try:
        redirect("/director")
        if authenticate() == True:
            print("FAIL")
    ...
    print("Test 13: Navigating to notes without logging in.")
    try:
        redirect("/notes")
        if authenticate() == True:
            print("FAIL")
